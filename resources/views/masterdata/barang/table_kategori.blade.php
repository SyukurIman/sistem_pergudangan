...
<div class="card mt-3">
    <div class="card-body">
        <div class="w-full sm:flex">
            <h3 class="text-lg sm:text-xl">Data Kategori Barang</h3>
            ...
            <table id="table" class="table table-striped" style="width: 100%;">
                <thead>
                    <tr class="tr-table">
                        ...
                        <th class="th-table" style="font-size: 12px;">Nama Kategori</th>
                        <th class="th-table" style="font-size: 12px;">Tanggal </th>
                    </tr>
                </thead>
